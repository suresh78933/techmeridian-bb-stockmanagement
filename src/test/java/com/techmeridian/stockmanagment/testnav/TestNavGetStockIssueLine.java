...
public class TestNavGetStockIssueLine {
	...
	public static void main(String[] args) {
		try {
			SoapObject response = ConnectToNAVCodeUnit("urn:microsoft-dynamics-schemas/page/isssub",
					"http://122.166.222.116:50047/DynNAV/WS/CRONUS%20India%20Ltd./Page/IssSub",
					"urn:microsoft-dynamics-schemas/page/isssub:ReadMultiple", "ReadMultiple");

			System.out.println("***************************************");
			for (int j = 0; j < response.getPropertyCount(); j++) {
				SoapObject pii = (SoapObject) response.getProperty(j);
				
				System.out.println(getValue("Issue_Document_No", pii));
