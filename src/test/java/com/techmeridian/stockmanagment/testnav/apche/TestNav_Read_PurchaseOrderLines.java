...
public class TestNav_Read_PurchaseOrderLines {
	...
	public static void main(String[] args) {
		try {
			...
			String body = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><v:Envelope xmlns:v=\"http://schemas.xmlsoap.org/soap/envelope/\" "
					...
					+ "<Read xmlns=\"urn:microsoft-dynamics-schemas/page/purchaseorderlines\">"
					+ "<filter i:type=\"d:anyType\">" 
					+ "<Field i:type=\"d:string\">Document_Type</Field>"
					+ "<Criteria i:type=\"d:string\">Order</Criteria>" 
					+ "</filter>"
					+ "<filter i:type=\"d:anyType\">" 
					+ "<Field i:type=\"d:string\">Document_No</Field>"
					+ "<Criteria i:type=\"d:string\">104001</Criteria>" 
					+ "</filter>"
					+ "<filter i:type=\"d:anyType\">" 
					+ "<Field i:type=\"d:int\">Line_No</Field>"
					+ "<Criteria i:type=\"d:int\">104001</Criteria>" 
					+ "</filter>"
					+ "</Read>" 
					+ "</v:Body>"
					+ "</v:Envelope>";
			...
			httpPost.addHeader("SOAPAction", "urn:microsoft-dynamics-schemas/page/purchaseorderlines:Read");
