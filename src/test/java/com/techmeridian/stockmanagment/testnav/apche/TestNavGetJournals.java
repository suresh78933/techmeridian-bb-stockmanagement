...
public class TestNavGetJournals {
	...
	public static void main(String[] args) {
		try {
			...
			/*String body = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><v:Envelope xmlns:v=\"http://schemas.xmlsoap.org/soap/envelope/\" "
					...
					+ "<v:Header />"
					+ "<v:Body>"
					+ "<ReadMultiple xmlns=\"urn:microsoft-dynamics-schemas/page/itemjournalbatches\">"
					+ "<filter>"
					+ "<Field>Journal_Template_Name</Field>"
					+ "<Criteria>PHYS. INV.</Criteria>"
					+ "</filter>"
					+ "</ReadMultiple>"
					+ "</v:Body>"
					+ "</v:Envelope>";*/
			...
			String body = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><v:Envelope xmlns:v=\"http://schemas.xmlsoap.org/soap/envelope/\" "
					...
					+ "<Criteria i:type=\"d:string\">PHYS. INV.</Criteria>"
					+ "</filter>"
					+ "</ReadMultiple>"
					+ "</v:Body>"
					+ "</v:Envelope>";
			...
			HttpPost httpPost = new HttpPost(
					"http://49.206.24.37:50047/DynNAV/WS/CRONUS%20India%20Ltd./Page/ItemJournalBatches");
