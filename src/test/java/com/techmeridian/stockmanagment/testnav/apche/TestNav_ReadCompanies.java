...
public class TestNav_ReadCompanies {

	public static void main(String[] args) {
		try {
			SoapObject response = ConnectToNAVCodeUnit("urn:microsoft-dynamics-schemas/page/companies",
					"http://122.166.222.116:50047/DynNAV/WS/CRONUS%20India%20Ltd./Page/Companies",
					"urn:microsoft-dynamics-schemas/page/companies:ReadMultiple", "ReadMultiple");
