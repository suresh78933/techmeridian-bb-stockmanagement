...
public class TestNavGetLocations {
	...
	public static void main(String[] args) {
		try {
			...
			credentialsProvider.setCredentials(AuthScope.ANY,
					new NTCredentials("IT\\\\\\android", "india@1947", null, null));
			...
			HttpPost httpPost = new HttpPost(
					"http://122.166.222.116:50047/DynNAV/WS/CRONUS%20India%20Ltd./Page/ItemJournalBatches");
