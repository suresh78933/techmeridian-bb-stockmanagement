...
public class TestNavGetStockIssueLine {
	...
	public static void main(String[] args) {
		try {
			...
			String body = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><v:Envelope xmlns:v=\"http://schemas.xmlsoap.org/soap/envelope/\" "
					...
					+ "<v:Body>"
					+ "<Read xmlns=\"urn:microsoft-dynamics-schemas/page/isssub\">"
					
					+ "<Issue_Document_No i:type=\"d:string\">IS001</Issue_Document_No>"
					+ "<Line_No i:type=\"d:string\">1000</Line_No>"
			...
			httpPost.addHeader("SOAPAction", "urn:microsoft-dynamics-schemas/page/isssub:Read");
