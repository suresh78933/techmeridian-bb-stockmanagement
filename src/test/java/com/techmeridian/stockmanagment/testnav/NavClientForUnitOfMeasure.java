...
public class NavClientForUnitOfMeasure {

	public static void main(String[] args) {
		try {
			SoapObject response = ConnectToNAVCodeUnit("urn:microsoft-dynamics-schemas/page/unitsofmeasure",
					"http://122.166.222.116:50047/DynNAV/WS/CRONUS%20India%20Ltd./Page/UnitsOfMeasure",
					"urn:microsoft-dynamics-schemas/page/unitsofmeasure:ReadMultiple", "ReadMultiple");
			...
			for (int j = 0; j < response.getPropertyCount(); j++) {
				...
				System.out.println(getValue("International_Standard_Code", pii));
