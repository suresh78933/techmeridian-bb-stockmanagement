...
CREATE TABLE `item_master` (
  ...
  `production_bom_number` varchar(128) DEFAULT NULL,
  `routing_no` varchar(128) DEFAULT NULL,
...
CREATE TABLE `phy_journal_item` (
  ...
  `posting_date` varchar(64) DEFAULT NULL,
  ...
  `description` varchar(128) DEFAULT NULL,
  `gen_prod_posting_group` varchar(64) DEFAULT NULL,
...
CREATE TABLE `purchase_order_lines` (
  ...
  `line_no` varchar(64) DEFAULT NULL,
  `type` varchar(64) DEFAULT NULL,
  `item_no` varchar(64) DEFAULT NULL,
  `item_id` int(11) NOT NULL,
  `variant_code` varchar(64) DEFAULT NULL,
  `service_tax_registration_no` varchar(64) DEFAULT NULL,
  `vat_prod_posting_group` varchar(64) DEFAULT NULL,
  `description` varchar(64) DEFAULT NULL,
  `location_code` varchar(64) DEFAULT NULL,
  `bin_code` varchar(64) DEFAULT NULL,
  `unit_of_measure_code` varchar(64) DEFAULT NULL,
  `unit_of_measure` varchar(64) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  ...
  `direct_unit_cost` varchar(64) DEFAULT NULL,
  `line_amount` varchar(64) DEFAULT NULL,
  `line_discount_percent` varchar(64) DEFAULT NULL,
  `line_discount_amount` varchar(64) DEFAULT NULL,
  `requested_receipt_date` varchar(64) DEFAULT NULL,
  `promised_receipt_date` varchar(64) DEFAULT NULL,
  `planned_receipt_date` varchar(64) DEFAULT NULL,
  `expected_receipt_date` varchar(64) DEFAULT NULL,
...
CREATE TABLE `stock_issue` (
  ...
  `company_id` int(11) NOT NULL DEFAULT '1',
  `issue_no` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  `issue_description` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issue_ref_no` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issue_raise_by` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issue_raised_on` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issued_by` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issued_on` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `issued_to` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `global_dimension_1_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `global_dimension_2_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `stock_issue_lines` (
  ...
  `part_no` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `shelf_no` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `hmr_km` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `unit_of_measure` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `location` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `mobile_nav_quantity` int(11) DEFAULT NULL,
  `shortcut_dimension_1_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `shortcut_dimension_2_code` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `available_inventory` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `quantity_to_issue` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `quantity_issued` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `outstanding_quantity` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `unit_amount` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `amount` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `qty_per_unit_of_measure` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `total_inventory_on_issue` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=7327 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vendor_list` (
  ...
  `number` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  ...
  `fax_no` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `contact` varchar(64) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `purchaser_code` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `vendor_posting_group` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `gen_bus_posting_group` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `vat_bus_posting_group` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `search_name` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `shipment_method_code` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `currency_code` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `language_code` varchar(128) COLLATE ucs2_unicode_ci DEFAULT NULL,
  `company_id` int(11) NOT NULL DEFAULT '1',
...
) ENGINE=InnoDB AUTO_INCREMENT=3938 DEFAULT CHARSET=ucs2 COLLATE=ucs2_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-16  7:55:48
